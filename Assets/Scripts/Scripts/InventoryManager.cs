...
public class InventoryManager : MonoBehaviour
{
    ...
    //will take item and add it to list
    ...
    private bool EndItemMove()
    {
        ...
        else
        {
            ...
            {
                if (originalSlot.GetItem() == movingSlot.GetItem())//theyre the same item
                {
                ...
                else
                {
                    ...
                    originalSlot.AddItem(movingSlot.GetItem(), movingSlot.GetQuantity());// b = d
